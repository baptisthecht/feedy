...
const StatusBadge = React.forwardRef<HTMLDivElement, StatusBadgeRootProps>(
  (
...
StatusBadge.displayName = STATUS_BADGE_ROOT_NAME;
...
export { StatusBadge, StatusBadgeDot, StatusBadgeIcon };
